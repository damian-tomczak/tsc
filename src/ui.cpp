...
void Ui::setupSide()
{
    ...
    pConnHorizontalLayoutActions->addWidget(pConnButtonConnect);
    pConnButtonStop = new QToolButton(pConnGrp);
    pConnButtonStop->setText(QString::fromUtf8("Stop"));
    pConnHorizontalLayoutActions->addWidget(pConnButtonStop);
